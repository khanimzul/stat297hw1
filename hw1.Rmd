...
**Original value of c is 10 while new c is 3**
...
```{r, cache = TRUE, dependson= "computeA", echo=TRUE}
d = sqrt(((a)^2)+(2*b)+c) 
d
```
...
```{r, fig.cap="**Figure 1:** Histogram of 100 random samples from a standard normal distribution", fig.align='center'}
hist(rnorm(100), main = "", col = "lightgrey")
```
...
<div class="alert alert-info"> **The most important thing to do to achieve greatness in life is start believing in yourself :)** </div>
